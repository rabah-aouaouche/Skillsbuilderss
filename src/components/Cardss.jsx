      ...
      <div className="w-full py-[10rem] px-4 bg-white">
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
          <div className="w-fill shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
            ...
            <p className="text-center text-4xl font-bold">$149 Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eveniet dicta earum consequuntur asperiores animi veritatis minima illum, vero ipsum, molestiae sit est quae explicabo nesciunt, ratione fugit incidunt sunt soluta.</p>
